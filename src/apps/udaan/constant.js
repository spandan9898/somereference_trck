const UDAAN_STATUS_MAPPING = {
    ...
    'FW_PICKUP_FAILED_Seller Not Attempted - Vehicle Breakdown/Traffic': {'scan_type': 'PPF',
                                                                          'pickrr_sub_status_code': 'NA'},
    'FW_PICKUP_FAILED_Seller Not Attempted - Vehicle full': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'NA'},
    'FW_PICKUP_FAILED_Seller Not Attempted - No Entry Restriction': {'scan_type': 'PPF',
                                                                     'pickrr_sub_status_code': 'NSL'},
    'FW_PICKUP_FAILED_Pickup Attempted - Address not found. Seller not contactable': {'scan_type': 'PPF',
                                                                                      'pickrr_sub_status_code': 'SU'},
    'FW_PICKUP_FAILED_Seller Not Attempted - Shortage of time': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'NA'},
    'FW_PICKUP_FAILED_Seller Not Attempted - Tech Issue': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'SC'},
    'FW_PICKUP_FAILED_Attempted - Shop Closed': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'SC'},
    'FW_PICKUP_FAILED_Attempted - Order not packed': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'SNR'},
    'FW_PICKUP_FAILED_Attempted - Vehicle full': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'NA'},
    'FW_PICKUP_FAILED_Attempted - Poor Packaging': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'DAM'},
    'FW_PICKUP_FAILED_Attempted - Tech Issue': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'REJ'},
    'FW_PICKUP_FAILED_Attempted - Packet Id not matching': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'REJ'},
    'FW_PICKUP_FAILED_Attempted - Closed due to COVID Impact': {'scan_type': 'PPF', 'pickrr_sub_status_code': 'SC'},
    'FW_PICKUP_FAILED_Seller not attempted - Closed due to COVID Impact': {'scan_type': 'PPF',
    ...
    'FW_DELIVERY_ATTEMPTED_Market Shut - Covid Virus': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CNA'},
    'FW_DELIVERY_ATTEMPTED_Buyer not reachable over phone': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CNA'},
    'FW_DELIVERY_ATTEMPTED_Buyer not available/Shop closed/Out of station': {'scan_type': 'UD',
    ...
    'FW_DELIVERY_ATTEMPTED_Buyer rejected - shipment tampered': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CR'},
    'FW_DELIVERY_ATTEMPTED_Shipment RTO': {'scan_type': 'UD', 'pickrr_sub_status_code': 'OTH'},
    'FW_DELIVERY_ATTEMPTED_Buyer expecting Credit order/ GST or Invoice issue': {'scan_type': 'UD',
                                                                                 'pickrr_sub_status_code': 'CI'},
    'FW_DELIVERY_ATTEMPTED_Issue with previous order/ RVP': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CI'},
    'FW_DELIVERY_ATTEMPTED_Buyer refused to sign PoD/ Runsheet': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CI'},
