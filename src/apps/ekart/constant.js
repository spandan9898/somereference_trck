const EKART_STATUS_MAPPER = {
    ...
    'shipment_undelivered_unattempted_Vehicle Breakdown': {'scan_type': 'UD', 'pickrr_sub_status_code': 'SD'},
    'shipment_undelivered_unattempted_Security Instability': {'scan_type': 'UD', 'pickrr_sub_status_code': 'SD'},
    'shipment_undelivered_unattempted_Heavy Traffic': {'scan_type': 'UD', 'pickrr_sub_status_code': 'SD'},
    ...
    'shipment_undelivered_attempted_Incomplete Address': {'scan_type': 'UD', 'pickrr_sub_status_code': 'AI'},
    'shipment_undelivered_attempted_COD Not Ready': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CNR'},
    'shipment_undelivered_attempted_Door Lock': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CNA'},
    'shipment_undelivered_attempted_Customer Not Available': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CNA'},
    'shipment_undelivered_attempted_Request for reschedule. delivery_date changed to:<new date>': {'scan_type': 'UD',
                                                                                                   'pickrr_sub_status_code': 'CD'},
    'shipment_undelivered_attempted_Rejected OpenDelivery': {'scan_type': 'UD', 'pickrr_sub_status_code': 'OPDEL'},
    'shipment_undelivered_attempted_Customer Not Responding': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CNA'},
    ...
    'shipment_rto_created_ShipmentIntransitByondLimit': {'scan_type': 'UD', 'pickrr_sub_status_code': 'ODA'},
    ...
    'shipment_rto_created_Unavailable at Delivery Address': {'scan_type': 'UD', 'pickrr_sub_status_code': 'ODA'},
    'shipment_rto_created_Purchased by mistake': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CR'},
    'shipment_rto_created_Rejected_by_Customer_PostOBD': {'scan_type': 'UD', 'pickrr_sub_status_code': 'CR'},
