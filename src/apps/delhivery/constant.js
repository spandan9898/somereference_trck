...
const DELHIVERY_REVERSE_MAPPER_V2 = {
  "x-uco_pp": {
    courier_remark: "Received soft data for consignment",
    scan_type: "OP",
    pickrr_sub_status_code: "",
...
const PULL_CONSUMER_GROUP_NAME = "delhivery-group-pull";
const PULL_CONSUMER_TOPIC_NAME = "delhivery_pull";
